...
![coin](http://static.tumblr.com/ppdj5y9/Ae9mxmxtp/300coin.png)

coin-node is a client for Node.JS.

* Provide a one-stop resource for the Node.JS developer to get started with the coin integration.

## Dependencies

You'll need a running instance of [coind](https://github.com/onsightit/healthcoin) to connect with.

Then, install the coin-node NPM package.

`npm install coin-node`

## Example

```js
var coin = require('coin-node')()
...
TODO: Verify and test with coin.

The [coin API](https://github.com/Weltschmerz/Kapitalize#commands) is supported as direct methods. Use either camelcase or lowercase.
...
TODO: Verify and test these with coin.

All [coin API](https://en.bitcoin.it/wiki/Original_coin_client/API_Calls_list) commands are supported, in lowercase or camelcase form.
...
<tr>
<td> sendfrom </td>
<td> [fromaccount] [toaddress] [amount] [minconf=1] [comment] [comment-to] </td>
