...
// Coin description
exports.coinDescription = "SolarCoin description goes here.";

// Coin name / page heading
exports.coinName = "SolarCoin";

// The copyright for the footer
exports.copyRight = "Copyright (c) " + moment().utc().format("YYYY") + ", The " + this.coinName + " developers. All rights reserved.";

// Coin symbol, e.g. BTC, VRC, SLR, HCN, ...
exports.coinSymbol = "SLR";
