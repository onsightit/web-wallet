...
exports.appEmailPassword = "password";
exports.appEmailService = "gmail";

// MASTER_ACCOUNT will become an address label in the wallet.
// ***  DO NOT CHANGE THE ACCOUNT/PASSWORD AFTER FIRST RUN!  ***
exports.masterAccount    = "MASTER_ACCOUNT";    // Master login account, and Label to assign to "" wallet accounts.
exports.masterPassword   = "SecretPassword";    // Master password for UI.
exports.masterEmail      = "webmaster@example.com";  // Master email account for UI.
...
// Google reCaptcha private/public keys (Leave as '' to disable.)
